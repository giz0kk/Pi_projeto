...
(function () {
  ...
  const DEFAULT_AVATAR = "Imagens/icons pessoa.png";
  ...
  function authUrl(file) {
    return file + "?redirect=" + encodeURIComponent(currentReturnUrl());
  }
  ...
  function openAuthModal(message) {
    ...
    if (!modal) {
      ...
      modal.innerHTML =
        ...
        '    <a class="auth-login-btn" data-auth-login href="login.html">Fazer login</a>' +
        '    <a class="auth-register-btn" data-auth-register href="cadastro.html">Criar conta</a>' +
        '  </div>' +
        '</div>';
  ...
  function applyHeaderUser(profileLink, data) {
    ...
    if (!isLoggedIn()) {
      ...
      let registerLink = profileLink.parentElement ? profileLink.parentElement.querySelector(".user-register-link") : null;
      if (!registerLink && profileLink.parentElement) {
        registerLink = document.createElement("a");
        registerLink.className = "user-register-link";
        profileLink.insertAdjacentElement("afterend", registerLink);
      }
      if (registerLink) {
        registerLink.href = authUrl("cadastro.html");
    ...
    profileLink.setAttribute("href", "perfil.html");
  ...
  function initHeaderUserProfile() {
    ...
    fetch(new URL("meu_perfil.php", window.location.href).href, {
      method: "GET",
  ...
  function initMobileNav() {
    ...
    if (!btn) {
      ...
      const perfilLink =
        icones.querySelector('a[href*="perfil"]') ||
        icones.querySelector("a:last-of-type");
      if (perfilLink) {
        icones.insertBefore(btn, perfilLink);
      } else {
