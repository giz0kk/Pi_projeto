    ...
    <div class="icones">
      <div class="notif-wrapper">
        <button type="button" class="notif-btn" aria-label="Notificações">
          <img src="assets/images/icon notificacao.png" alt="" class="icon">
        </button>
      ...
      <a href="perfil.html"><img src="assets/images/icons pessoa.png" alt="Perfil"></a>
    </div>
  </header>
