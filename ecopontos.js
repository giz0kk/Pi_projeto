    ...
    return (
      '<div class="card-ecoponto card-ecoponto-dinamico is-selected" data-ecoponto-id="' + escHtml(ponto.id) + '">' +
        ...
        '<div class="materiais">' +
          ...
          '<div class="icons">' +
            '<div><img src="Imagens/garrafa.png" alt="Plástico"><span>Plástico</span></div>' +
            '<div><img src="Imagens/papel.png" alt="Papel"><span>Papel</span></div>' +
            '<div><img src="Imagens/vidro.png" alt="Vidro"><span>Vidro</span></div>' +
            '<div><img src="Imagens/lata.png" alt="Metal"><span>Metal</span></div>' +
            '<div><img src="Imagens/madeira.png" alt="Madeira"><span>Madeira</span></div>' +
            '<div><img src="Imagens/eletronicos.png" alt="Eletrônicos"><span>Eletrônicos</span></div>' +
          '</div>' +
        '</div>' +
